...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pesan'
        db.create_table(u'cicip_pesan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('pesan', self.gf('django.db.models.fields.TextField')()),
            ('tgl_pesan', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('sudah_baca', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'cicip', ['Pesan'])


    def backwards(self, orm):
        # Deleting model 'Pesan'
        db.delete_table(u'cicip_pesan')
