...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TemplateOS.jenis'
        db.add_column(u'cicip_templateos', 'jenis',
                      self.gf('django.db.models.fields.CharField')(default='disk', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TemplateOS.jenis'
        db.delete_column(u'cicip_templateos', 'jenis')
