...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfilPengguna.jenis_kelamin'
        db.add_column(u'cicip_profilpengguna', 'jenis_kelamin',
                      self.gf('django.db.models.fields.CharField')(default='L', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfilPengguna.jenis_kelamin'
        db.delete_column(u'cicip_profilpengguna', 'jenis_kelamin')
