...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.active'
        db.add_column(u'virt_virtualmachine', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.active'
        db.delete_column(u'virt_virtualmachine', 'active')
    ...
    models = {
        ...
        u'cicip.templateos': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jenis': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        u'virt.virtualmachine': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'up'", 'max_length': '10'}),
