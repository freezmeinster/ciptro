...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.reg_date'
        db.add_column(u'virt_virtualmachine', 'reg_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'VirtualMachine.state'
        db.add_column(u'virt_virtualmachine', 'state',
                      self.gf('django.db.models.fields.CharField')(default='down', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.reg_date'
        db.delete_column(u'virt_virtualmachine', 'reg_date')

        # Deleting field 'VirtualMachine.state'
        db.delete_column(u'virt_virtualmachine', 'state')
