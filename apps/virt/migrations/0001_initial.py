...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'virt_virtualmachine', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('distro_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cicip.Version'])),
            ('mem', self.gf('django.db.models.fields.IntegerField')()),
            ('vnc_port', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('websocket_port', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal(u'virt', ['VirtualMachine'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'virt_virtualmachine')
